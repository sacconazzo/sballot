      ...
      <Dialog fullWidth open={props.open} onClose={handleOnClose} aria-labelledby="form-dialog-title">
          ...
          <form className={classes.form} noValidate>
            <FormControl className={classes.formControl}>
              <TextField
                ...
                onChange={(e) =>
                  setForm({ alias: e.target.value, password: form.password, repassword: form.repassword })
                }
                label="Alias"
              />
            </FormControl>
            <FormControl className={classes.formControl}>
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm({ alias: form.alias, password: btoa(e.target.value), repassword: form.repassword })
                }
                endAdornment={
            ...
            <FormControl className={classes.formControl}>
              ...
              <Input
                ...
                type={visible ? "text" : "password"}
                onChange={(e) =>
                  setForm({ alias: form.alias, password: form.password, repassword: btoa(e.target.value) })
                }
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton
              ...
              {form.password !== form.repassword && (
                <FormHelperText id="standard-weight-helper-text">Password not equal</FormHelperText>
              )}
            </FormControl>
          </form>
        </DialogContent>
        <DialogActions>
          ...
          <div className={classes.wrapper}>
            <Button
              onClick={create}
              disabled={loader || form.password !== form.repassword}
              variant="contained"
              color="primary"
            >
              Create
